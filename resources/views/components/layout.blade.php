...
{{--                <div class="bg-sky-50/10 backdrop-blur-sm rounded-2xl p-2 sm:p-4 border border-sky-200/30">--}}
...
{{--    </div>--}}
{{--</div>--}}
{{-- Кнопка "Содержание" (ВНЕ основного контейнера) --}}
{{--<button--}}
{{--    x-show="tocAvailable"--}}
...
{{--        class="absolute left-0 top-0 h-full w-72 bg-sky-50 shadow-xl p-2 sm:p-4 overflow-y-auto"--}}
{{--    >--}}
...
{{--        x-transition:leave-start="translate-x-0"--}}
{{--        x-transition:leave-end="translate-x-full"--}}
{{--        class="absolute right-0 top-0 h-full w-72 bg-sky-50 shadow-xl p-2 sm:p-4 overflow-y-auto"--}}
{{--    >--}}
{{--        <div class="flex justify-between items-center mb-4">--}}
