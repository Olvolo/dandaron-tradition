...
{{--                            value="{{ request('q') }}"--}}
{{--                            placeholder="Поиск..."--}}
{{--                            class="w-full pl-4 pr-10 py-2 border border-sky-600-300 rounded-lg--}}
{{--                            focus:outline-none focus:ring-2 focus:ring-sky-400 text-sm text-sky-800"--}}
{{--                        >--}}
{{--                        <button type="submit" class="absolute right-3 top-1/2 transform--}}
{{--                        -translate-y-1/2 text-sky-600 hover:text-sky-600 transition-colors">--}}
...
{{--        <div class="xl:hidden pb-4 border-t border-sky-300 pt-4">--}}
{{--            <x-search-form />--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</header>--}}
...
<header class="bg-sky-200 border-b border-sky-300 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Поисковая форма для планшетов и мобильных - уменьшенные отступы --}}
        <div class="xl:hidden pb-0.5 border-t border-sky-300 pt-0.5">
            <x-search-form />
        </div>
    </div>
</header>
