            ...
            <div class="max-w-4xl mx-auto flex justify-end mb-4 px-4 sm:px-0">
                <div class="inline-flex rounded-md shadow-sm">
                    ...
                    <button
                        ...
                        :class="{ 'bg-sky-700 text-white': view === 'grid', 'bg-white text-sky-600 hover:bg-sky-50': view !== 'grid' }"
                    ...
                    <button
                        ...
                        :class="{ 'bg-sky-700 text-white': view === 'list', 'bg-white text-sky-600 hover:bg-sky-50': view !== 'list' }"
