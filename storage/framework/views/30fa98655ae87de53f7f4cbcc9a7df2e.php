...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-sm text-sky-700">
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="underline text-sm text-sky-700 hover:text-sky-950 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dandaron-tradition\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>