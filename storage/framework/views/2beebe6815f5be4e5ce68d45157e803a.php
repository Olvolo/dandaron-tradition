    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr wire:key="book-<?php echo e($book->id); ?>">
                    <td class="px-6 py-4 whitespace-nowrap font-medium"><?php echo e($book->title); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($book->authors->pluck('name')->join(', ')); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="<?php echo e(route('admin.books.edit', $book)); ?>" class="text-indigo-600 hover:text-indigo-900" wire:navigate>Редактировать</a>
                        <button wire:click="delete(<?php echo e($book->id); ?>)" wire:confirm="Вы уверены?" class="text-red-600 hover:text-red-900 ml-4">Удалить</button>
                    </td>
                </tr>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isModalOpen): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl">
                <h2 class="text-xl font-bold mb-4"><?php echo e($book_id ? 'Редактировать книгу' : 'Создать книгу'); ?></h2>
                <form>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input id="is_protected_book" wire:model.defer="is_protected" type="checkbox" class="h-4 w-4 text-indigo-600 border-gray-300 rounded">
                            <label for="is_protected_book" class="ml-2 block text-sm text-gray-900">Защищено (только для вошедших)</label>
                        </div>
                    </div>
                </form>
...
<?php /**PATH C:\laragon\www\dandaron-tradition\resources\views/livewire/admin/content/manage-books.blade.php ENDPATH**/ ?>