        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-950">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user() && Auth::user()->isAdmin()): ?>
                        <div class="mt-4 border-t pt-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <a href="<?php echo e(url('/admin/sandbox/html-preview')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dandaron-tradition\resources\views/dashboard.blade.php ENDPATH**/ ?>