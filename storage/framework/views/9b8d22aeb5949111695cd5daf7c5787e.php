...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-sky-700 hover:text-sky-950 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('login')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dandaron-tradition\resources\views\auth\register.blade.php ENDPATH**/ ?>